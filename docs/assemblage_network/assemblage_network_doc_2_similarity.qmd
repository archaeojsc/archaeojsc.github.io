...
Unlike the overlap coefficient, you can see that the Jaccard index considers the *total* cardinality of the sets being compared in the denominator. That means that this index will *always* penalize differences between sets, even if one is a proper subset of the other.
