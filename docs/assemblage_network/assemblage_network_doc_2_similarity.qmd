...
The inherent *structure* that we\'re looking for isn\'t likely to be found in those samples. Luckily, we now know that the *bulk* of the samples should (when projected as one-mode graphs) have a much smaller graph node *degree* than what we found in our \"everything-to-everything\" projections from before. 

## Comparing Similarity Measures

### Comparing similarities for proveniences
...
### Comparing similarities for artifact types
