...
[^2]: I'm also sometimes asked the inverse -- what does archaeology have to do with *data science* -- by my archaeological colleagues as well. Quantitative and computational (or "digital") archaeology has been a around for a long while, but we're still something of a minority. That's a subject for a different post, though.
